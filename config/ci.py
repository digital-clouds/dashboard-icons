...
def generate_img_tag(file):
    return f'<a href="https://cdn.jsdelivr.net/gh/digital-clouds/dashboard-icons@main/png/{file.name}"><img src="https://cdn.jsdelivr.net/gh/digital-clouds/dashboard-icons@main/png/{file.name}" alt="{file.stem}" height="50"></a>'
